...
metadata {
    ...
    definition (name: "Sim Temperature Sensor", namespace: "mbarone/apps", author: "mbarone", mnmn: "SmartThings", vid: "generic-radiator-thermostat-2", ocfDeviceType: "oic.d.thermostat") {
