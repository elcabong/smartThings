 ...
 */
metadata {
	definition (name: "Child Humidity Sensor", namespace: "ogiewon", author: "Daniel Ogorchock", mnmn:"SmartThings", vid: "generic-humidity-3", ocfDeviceType: "oic.d.airconditioner") {
