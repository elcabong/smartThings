...
metadata {
    ...
    command "Off"
 	...
 	tiles {
    	valueTile("Main", "device.Main", width: 2, height: 2) {
        ...
        standardTile("Refresh", "device.switch", inactiveLabel: false, width: 1, height: 1, decoration: "flat", wordWrap: true) {
            state "off", action:"On", label: "", icon:"st.secondary.refresh"
            state "on", label: "", icon:"st.motion.motion.active"
        }
        standardTile("Details", "device.Details", inactiveLabel: false, width: 1, height: 1, decoration: "flat", wordWrap: true) {
        ...
        valueTile("Title0", "device.Title0", width: 2, height: 1) {
 			state( "default", label:'${currentValue}')
 		}
        valueTile("Title1", "device.Title1", width: 2, height: 1) {
 			state( "default", label:'${currentValue}')
 		}
        valueTile("Title2", "device.Title2", width: 2, height: 1) {
 			state( "default", label:'${currentValue}')
 		}
        valueTile("Title3", "device.Title3", width: 2, height: 1) {
 			state( "default", label:'${currentValue}')
 		}
        valueTile("Title4", "device.Title4", width: 2, height: 1) {
 			state( "default", label:'${currentValue}')
 		}
        valueTile("Title5", "device.Title5", width: 2, height: 1) {
 			state( "default", label:'${currentValue}')
 		}
        valueTile("Title6", "device.Title6", width: 2, height: 1) {
 			state( "default", label:'${currentValue}')
 		}
        valueTile("Title7", "device.Title7", width: 2, height: 1) {
 			state( "default", label:'${currentValue}')
 		}
        valueTile("Title8", "device.Title8", width: 2, height: 1) {
 			state( "default", label:'${currentValue}')
 		}
        valueTile("Title9", "device.Title9", width: 2, height: 1) {
 			state( "default", label:'${currentValue}')
 		}
 		main(["Main"])
